...
#include <string.h>
 class DateTime {
public:
  int gyear,nongliyear,nonglimonth,nongliday, gmonth, gday;
  int ghour,gminute, gsecond;
  DateTime();
  ~DateTime();
  void showTime();
  int showMoon(int year,int month,int day);  //作业：将当前公历转换为农历显示出来 
};
...
int DateTime::showMoon(int year,int month,int day)
{
 ...
 int main()
{
	...
	year=dt.gyear;month=dt.gmonth;day=dt.gday;
#endif
	/*printf("%d年%d月%d日\t",year,month,day);*/
	if (dt1.showMoon(year,month,day))
	{
		strcat(str,"闰");
...
DateTime::DateTime()
{
  gyear =2020;nongliyear= 2020; gmonth = 3; gday = 20;
  nonglimonth=2;nongliday=27;
  ghour = 11; gminute = 27; gsecond = 55;
}
DateTime::~DateTime() 
{
}
void DateTime::showTime()
{
  printf("当前时间：\n公历：%d/%d/%d %d:%d:%d\n农历：", gyear, gmonth, gday, ghour, gminute, gsecond);
}

>>>>>>> f099655cbddda542004b6fa81d3e292d00ac9dd8
